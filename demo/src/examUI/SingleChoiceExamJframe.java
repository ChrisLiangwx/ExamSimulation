...
public class SingleChoiceExamJframe {//考试窗口
//答题结果存储在result表中，因此每次答题之前需要先删除result表中的所有内容
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					SingleChoiceExamJframe window = new SingleChoiceExamJframe(args);
...
//	}
	 ...
	 */
	public SingleChoiceExamJframe(String[] args){
		frame = new JFrame();
		frame.setTitle("\u5355\u9879\u9009\u62E9");
		//使显示在屏幕中央
...
/*----------------------------------------------------------------------------------------------------*/		
		if(QuestionSeq==0)//若是顺序答题
			for(int i = 1 ; i <= QuestionNo ; i++) {
				...
				Label_QuestionStem.setText(i+"."+content_stem);
	            Label_QuestionStem.setFont(new Font("宋体", Font.PLAIN, 20));
				Label_QuestionStem.setBounds(29, 130, 3000, 24);
				...
				group.add(RadioButton_A);
				group.add(RadioButton_B);
				group.add(RadioButton_C);
				group.add(RadioButton_D);
				...
				RadioButton_A.addActionListener(new ActionListener(){
					public void actionPerformed(ActionEvent e){
						...
						if(!SingleChoiceExamJframe.isExist(User.qbName+User.userID+String.valueOf(j))) {//不存在，插入新数据
							String sql="insert into result (QuestionNo,QuestionID,QuestionStem,A,B,C,D,Answer,MyAnswer) values(?,?,?,?,?,?,?,?,?)";
							String[] str=new String[]{String.valueOf(j), User.qbName+User.userID+String.valueOf(j), stem, A, B, C, D, answer,"A"};
							exam.AddOrUpdate(sql, str);
							System.out.println("第"+j+"题选：A");	
						}
						else {//已存在，更改数据
							String sql="update result set MyAnswer=? where QuestionID=?";
							String[] str=new String[]{"A",User.qbName+User.userID+String.valueOf(j)};
							exam.AddOrUpdate(sql, str);
							System.out.println("第"+j+"题更改为：A");	
						}							
					}
				});
				...
				RadioButton_B.addActionListener(new ActionListener(){
					public void actionPerformed(ActionEvent e){
						...
						if(!SingleChoiceExamJframe.isExist(User.qbName+User.userID+String.valueOf(j))) {//不存在，插入新数据
							String sql="insert into result (QuestionNo,QuestionID,QuestionStem,A,B,C,D,Answer,MyAnswer) values(?,?,?,?,?,?,?,?,?)";
							String[] str=new String[]{String.valueOf(j), User.qbName+User.userID+String.valueOf(j), stem, A, B, C, D, answer,"B"};
							exam.AddOrUpdate(sql, str);
							System.out.println("第"+j+"题选：B");	
						}
						else {//已存在，更改数据
							String sql="update result set MyAnswer=? where QuestionID=?";
							String[] str=new String[]{"B",User.qbName+User.userID+String.valueOf(j)};
							exam.AddOrUpdate(sql, str);
							System.out.println("第"+j+"题更改为：B");	
						}			
					}
				});
				...
				RadioButton_C.addActionListener(new ActionListener(){
					public void actionPerformed(ActionEvent e){
						...
						if(!SingleChoiceExamJframe.isExist(User.qbName+User.userID+String.valueOf(j))) {//不存在，插入新数据
							String sql="insert into result (QuestionNo,QuestionID,QuestionStem,A,B,C,D,Answer,MyAnswer) values(?,?,?,?,?,?,?,?,?)";
							String[] str=new String[]{String.valueOf(j), User.qbName+User.userID+String.valueOf(j), stem, A, B, C, D, answer,"C"};
							exam.AddOrUpdate(sql, str);
							System.out.println("第"+j+"题选：C");	
						}
						else {//已存在，更改数据
							String sql="update result set MyAnswer=? where QuestionID=?";
							String[] str=new String[]{"C",User.qbName+User.userID+String.valueOf(j)};
							exam.AddOrUpdate(sql, str);
							System.out.println("第"+j+"题更改为：C");	
						}			
					}
				});
				...
				RadioButton_D.addActionListener(new ActionListener(){
					public void actionPerformed(ActionEvent e){
						...
						if(!SingleChoiceExamJframe.isExist(User.qbName+User.userID+String.valueOf(j))) {//不存在，插入新数据
							String sql="insert into result (QuestionNo,QuestionID,QuestionStem,A,B,C,D,Answer,MyAnswer) values(?,?,?,?,?,?,?,?,?)";
							String[] str=new String[]{String.valueOf(j), User.qbName+User.userID+String.valueOf(j), stem, A, B, C, D, answer,"D"};
							exam.AddOrUpdate(sql, str);
							System.out.println("第"+j+"题选：D");	
						}
						else {//已存在，更改数据
							String sql="update result set MyAnswer=? where QuestionID=?";
							String[] str=new String[]{"D",User.qbName+User.userID+String.valueOf(j)};
							exam.AddOrUpdate(sql, str);
							System.out.println("第"+j+"题更改为：D");	
						}				
					}
				});
...
/*----------------------------------------------------------------------------------------------------*/
		...
		{//首先需要获取题库中有多少道题，以及本次考试的题量，然后调用RandomNum中的方法生成代表题号的随机数组
			...
			for(int i = 0 ; i < QuestionNo ; i++) {
	            ...
	            //System.out.println(s);
				Label_QuestionStem = new JLabel("\u9898\u5E72");
				Label_QuestionStem.setText(i+1+"."+content_stem);
	            Label_QuestionStem.setFont(new Font("宋体", Font.PLAIN, 20));
				Label_QuestionStem.setBounds(29, 130, 3000, 24);
				//select QuestionStem from question where QuestionID = i
				...
				RadioButton_A.addActionListener(new ActionListener(){
					public void actionPerformed(ActionEvent e){
						...
						if(cnt<=QuestionNo)
							textField_ShowQuestionNo.setText("第"+cnt+"题/共"+args[1]+"题");
						if(!SingleChoiceExamJframe.isExist(User.qbName+User.userID+String.valueOf(array[j-1]))) {//不存在，插入新数据
							String sql="insert into result (QuestionNo,QuestionID,QuestionStem,A,B,C,D,Answer,MyAnswer) values(?,?,?,?,?,?,?,?,?)";
							String[] str=new String[]{String.valueOf(j), User.qbName+User.userID+String.valueOf(array[j-1]), stem, A, B, C, D, answer,"A"};
							exam.AddOrUpdate(sql, str);
							System.out.println("第"+j+"题选：A");
						}
						else {//已存在，更改数据
							String sql="update result set MyAnswer=? where QuestionID=?";
							String[] str=new String[]{"A",User.qbName+User.userID+String.valueOf(array[j-1])};
							exam.AddOrUpdate(sql, str);
							System.out.println("第"+j+"题更改为：A");	
						}			
					}
				...
				RadioButton_B.addActionListener(new ActionListener(){
					public void actionPerformed(ActionEvent e){
						...
						if(!SingleChoiceExamJframe.isExist(User.qbName+User.userID+String.valueOf(array[j-1]))) {//不存在，插入新数据
							String sql="insert into result (QuestionNo,QuestionID,QuestionStem,A,B,C,D,Answer,MyAnswer) values(?,?,?,?,?,?,?,?,?)";
							String[] str=new String[]{String.valueOf(j), User.qbName+User.userID+String.valueOf(array[j-1]), stem, A, B, C, D, answer,"B"};
							exam.AddOrUpdate(sql, str);
							System.out.println("第"+j+"题选：B");	
						}
						else {//已存在，更改数据
							String sql="update result set MyAnswer=? where QuestionID=?";
							String[] str=new String[]{"B",User.qbName+User.userID+String.valueOf(array[j-1])};
							exam.AddOrUpdate(sql, str);
							System.out.println("第"+j+"题更改为：B");	
						}
					}
				...
				RadioButton_C.addActionListener(new ActionListener(){
					public void actionPerformed(ActionEvent e){
						...
						if(!SingleChoiceExamJframe.isExist(User.qbName+User.userID+String.valueOf(array[j-1]))) {//不存在，插入新数据
							String sql="insert into result (QuestionNo,QuestionID,QuestionStem,A,B,C,D,Answer,MyAnswer) values(?,?,?,?,?,?,?,?,?)";
							String[] str=new String[]{String.valueOf(j), User.qbName+User.userID+String.valueOf(array[j-1]), stem, A, B, C, D, answer,"C"};
							exam.AddOrUpdate(sql, str);
							System.out.println("第"+j+"题选：C");	
						}
						else {//已存在，更改数据
							String sql="update result set MyAnswer=? where QuestionID=?";
							String[] str=new String[]{"C",User.qbName+User.userID+String.valueOf(array[j-1])};
							exam.AddOrUpdate(sql, str);
							System.out.println("第"+j+"题更改为：C");	
						}				
					}
				...
				RadioButton_D.addActionListener(new ActionListener(){
					public void actionPerformed(ActionEvent e){
						...
						if(!SingleChoiceExamJframe.isExist(User.qbName+User.userID+String.valueOf(array[j-1]))) {//不存在，插入新数据
							String sql="insert into result (QuestionNo,QuestionID,QuestionStem,A,B,C,D,Answer,MyAnswer) values(?,?,?,?,?,?,?,?,?)";
							String[] str=new String[]{String.valueOf(j), User.qbName+User.userID+String.valueOf(array[j-1]), stem, A, B, C, D, answer,"D"};
							exam.AddOrUpdate(sql, str);
							System.out.println("第"+j+"题选：D");	
						}
						else {//已存在，更改数据
							String sql="update result set MyAnswer=? where QuestionID=?";
							String[] str=new String[]{"D",User.qbName+User.userID+String.valueOf(array[j-1])};
							exam.AddOrUpdate(sql, str);
							System.out.println("第"+j+"题更改为：D");	
						}				
					}
