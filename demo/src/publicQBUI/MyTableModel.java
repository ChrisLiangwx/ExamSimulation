...
public class MyTableModel extends AbstractTableModel
{
	...
	public int getQBnum() {//统计题库数
		...
		String sql="SELECT DISTINCT COUNT(DISTINCT questionbankname) FROM question where Owner='admin'";
	...
	public String[] getQBname() {//查询题库名
		...
		DBUtil questionbank = new DBUtil();
		String sql="SELECT DISTINCT questionbankname FROM question where Owner='admin'";
        //String []str=new String[]{User.userName};
	...
	public String[] getQBtype() {//查询每个题库内的题目类型
		...
		DBUtil questionbank = new DBUtil();
		String sql="SELECT DISTINCT questionbankname,questionbanktype FROM question where Owner='admin'";
        //String []str=new String[]{User.userName};
        ResultSet rs=questionbank.Search(sql, null);
        //从数据库中获得查询结果
        try {
