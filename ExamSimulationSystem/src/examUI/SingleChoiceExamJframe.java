			...
			for(int i = 1 ; i <= QuestionNo ; i++) {
				...
				RadioButton_A.addActionListener(new ActionListener(){
					public void actionPerformed(ActionEvent e){
						...
						if(!SingleChoiceExamJframe.isExist(User.qbName+User.userID+String.valueOf(j))) {//不存在，插入新数据
							...
							String[] str=new String[]{String.valueOf(j), User.qbName+User.userID+String.valueOf(j), stem, A, B, C, D, answer,"A",User.userID};
				...
				RadioButton_B.addActionListener(new ActionListener(){
					public void actionPerformed(ActionEvent e){
						...
						if(!SingleChoiceExamJframe.isExist(User.qbName+User.userID+String.valueOf(j))) {//不存在，插入新数据
							String sql="insert into result (QuestionNo,QuestionID,QuestionStem,A,B,C,D,Answer,MyAnswer,UserID) values(?,?,?,?,?,?,?,?,?,?)";
							String[] str=new String[]{String.valueOf(j), User.qbName+User.userID+String.valueOf(j), stem, A, B, C, D, answer,"B",User.userID};
							exam.AddOrUpdate(sql, str);
				...
				RadioButton_C.addActionListener(new ActionListener(){
					public void actionPerformed(ActionEvent e){
						...
						if(!SingleChoiceExamJframe.isExist(User.qbName+User.userID+String.valueOf(j))) {//不存在，插入新数据
							String sql="insert into result (QuestionNo,QuestionID,QuestionStem,A,B,C,D,Answer,MyAnswer,UserID) values(?,?,?,?,?,?,?,?,?,?)";
							String[] str=new String[]{String.valueOf(j), User.qbName+User.userID+String.valueOf(j), stem, A, B, C, D, answer,"C",User.userID};
							exam.AddOrUpdate(sql, str);
				...
				RadioButton_D.addActionListener(new ActionListener(){
					public void actionPerformed(ActionEvent e){
						...
						if(!SingleChoiceExamJframe.isExist(User.qbName+User.userID+String.valueOf(j))) {//不存在，插入新数据
							String sql="insert into result (QuestionNo,QuestionID,QuestionStem,A,B,C,D,Answer,MyAnswer,UserID) values(?,?,?,?,?,?,?,?,?,?)";
							String[] str=new String[]{String.valueOf(j), User.qbName+User.userID+String.valueOf(j), stem, A, B, C, D, answer,"D",User.userID};
							exam.AddOrUpdate(sql, str);
			...
			for(int i = 0 ; i < QuestionNo ; i++) {
				...
				RadioButton_A.addActionListener(new ActionListener(){
					public void actionPerformed(ActionEvent e){
						...
						if(!SingleChoiceExamJframe.isExist(User.qbName+User.userID+String.valueOf(array[j-1]))) {//不存在，插入新数据
							String sql="insert into result (QuestionNo,QuestionID,QuestionStem,A,B,C,D,Answer,MyAnswer,UserID) values(?,?,?,?,?,?,?,?,?,?)";
							String[] str=new String[]{String.valueOf(j), User.qbName+User.userID+String.valueOf(array[j-1]), stem, A, B, C, D, answer,"A",User.userID};
							exam.AddOrUpdate(sql, str);
							System.out.println("第"+j+"题选：A");
						}
						else {//已存在，更改数据
				...
				RadioButton_B.addActionListener(new ActionListener(){
					public void actionPerformed(ActionEvent e){
						...
						if(!SingleChoiceExamJframe.isExist(User.qbName+User.userID+String.valueOf(array[j-1]))) {//不存在，插入新数据
							String sql="insert into result (QuestionNo,QuestionID,QuestionStem,A,B,C,D,Answer,MyAnswer,UserID) values(?,?,?,?,?,?,?,?,?,?)";
							String[] str=new String[]{String.valueOf(j), User.qbName+User.userID+String.valueOf(array[j-1]), stem, A, B, C, D, answer,"B",User.userID};
							exam.AddOrUpdate(sql, str);
							System.out.println("第"+j+"题选：B");	
						}
						else {//已存在，更改数据
				...
				RadioButton_C.addActionListener(new ActionListener(){
					public void actionPerformed(ActionEvent e){
						...
						if(!SingleChoiceExamJframe.isExist(User.qbName+User.userID+String.valueOf(array[j-1]))) {//不存在，插入新数据
							String sql="insert into result (QuestionNo,QuestionID,QuestionStem,A,B,C,D,Answer,MyAnswer,UserID) values(?,?,?,?,?,?,?,?,?,?)";
							String[] str=new String[]{String.valueOf(j), User.qbName+User.userID+String.valueOf(array[j-1]), stem, A, B, C, D, answer,"C",User.userID};
							exam.AddOrUpdate(sql, str);
							System.out.println("第"+j+"题选：C");	
						}
						else {//已存在，更改数据
				...
				RadioButton_D.addActionListener(new ActionListener(){
					public void actionPerformed(ActionEvent e){
						...
						if(!SingleChoiceExamJframe.isExist(User.qbName+User.userID+String.valueOf(array[j-1]))) {//不存在，插入新数据
							String sql="insert into result (QuestionNo,QuestionID,QuestionStem,A,B,C,D,Answer,MyAnswer,UserID) values(?,?,?,?,?,?,?,?,?,?)";
							String[] str=new String[]{String.valueOf(j), User.qbName+User.userID+String.valueOf(array[j-1]), stem, A, B, C, D, answer,"D",User.userID};
							exam.AddOrUpdate(sql, str);
							System.out.println("第"+j+"题选：D");	
						}
						else {//已存在，更改数据
